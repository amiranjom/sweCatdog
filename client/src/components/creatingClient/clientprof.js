                        ...
                        <Grid.Row>
                            ...
                            <Grid.Column width={6}>
                                ...
                                <Segment>
                                    ...
                                    <Icon name='folder open outline' size='large'/><p className="amir-class">{this.state.pending ? this.state.postInfo.length : ''}<Icon className="amir-class" name={this.state.pending ? 'bell' : '' }  size='large'/></p>
